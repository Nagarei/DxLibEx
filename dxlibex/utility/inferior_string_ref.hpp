...
namespace utility {
	...
	public:
		...
		DXLE_CONSTEXPR basic_inferior_string_ref(const char_type* str) : str_(str) {}
		...
		DXLE_CXX14_CONSTEXPR basic_inferior_string_ref& operator=(const basic_inferior_string_ref& o) DXLE_NOEXCEPT_OR_NOTHROW { this->str_ = o.str_; return *this; }
		DXLE_CXX14_CONSTEXPR basic_inferior_string_ref& operator=(basic_inferior_string_ref&& o) DXLE_NOEXCEPT_OR_NOTHROW { this->str_ = o.str_; return *this; }
		const char_type* c_str() const DXLE_NOEXCEPT_OR_NOTHROW { return this->str_; }
	};
